...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { body: @agency.body, datetime: @agency.datetime, description: @agency.description, rating: @agency.rating, title: @agency.title } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { body: @agency.body, datetime: @agency.datetime, description: @agency.description, rating: @agency.rating, title: @agency.title } }
