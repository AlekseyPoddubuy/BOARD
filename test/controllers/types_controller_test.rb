...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { body: @type.body, slug: @type.slug, title: @type.title } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { body: @type.body, slug: @type.slug, title: @type.title } }
